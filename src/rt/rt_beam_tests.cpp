...
TEST(UnboundBeam, LineSegmentCompletelyInsideBeam) {
  const UnboundBeam u_beam{{{0, 0}, {-1, 1}},
                           {{0, 0}, {1, 1}}};
...
TEST(UnboundBeam,
     LineSegmentLeftSideInBeamRightSideOutside) {
  const UnboundBeam u_beam{{{0, 0}, {-1, 1}},
                           {{0, 0}, {1, 1}}};
...
TEST(UnboundBeam,
     LineSegmentLeftSideOutsideBeamRightSideInside) {
  const UnboundBeam u_beam{{{0, 0}, {-1, 1}},
                           {{0, 0}, {1, 1}}};
...
TEST(UnboundBeam,
     LineSegmentBothSidesOutsideButLineCrosses) {
  const UnboundBeam u_beam{{{0, 0}, {-1, 1}},
                           {{0, 0}, {1, 1}}};
